...
<body>
    ...
    <h1 class="title-produto">Produtos</h1>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
    ...
    <div class="col">
        <div class="card h-100">
            <img src="ExibirFotoProduto?id=<%= p.getId()%>" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title"><%= p.getDescricao()%></h5>
                <p class="card-text">Preço: R$<%= p.getPreco()%></p>
                <p class="card-text">Estoque: <%= p.getQuantidade()%></p>
            </div>
            <div class="card-footer">
                <small class="text-muted"><a href="AdicionarProdutoCarrinho?produtoId=<%= p.getId()%>" class="btn btn-dark">Comprar</a></small>
            </div>
        </div>
    </div>
    <%
